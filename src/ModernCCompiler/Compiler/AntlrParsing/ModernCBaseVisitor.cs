...
public partial class ModernCBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IModernCVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitReadStatement([NotNull] ModernCParser.ReadStatementContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCallExpression([NotNull] ModernCParser.CallExpressionContext context) { return VisitChildren(context); }
	/// <summary>
